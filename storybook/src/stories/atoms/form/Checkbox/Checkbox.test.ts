...
describe('checkbox', () => {
  ...
  it('changes v-model on change', async () => {
    ...
    expect(Object.keys(wrapper.get('[data-test-id="checkbox-input"]').attributes())).not.toContain('checked')
    ...
    expect(Object.keys(wrapper.get('[data-test-id="checkbox-input"]').attributes())).toContain('checked')
  })
})
