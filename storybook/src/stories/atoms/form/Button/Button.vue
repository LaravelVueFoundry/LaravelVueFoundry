...
<template>
  <component
    :is="buttonType"
    :class="twMerge(
      'inline-flex items-center gap-2 border font-medium text-white shadow hover:shadow-md active:shadow-none disabled:pointer-events-none disabled:opacity-50',
