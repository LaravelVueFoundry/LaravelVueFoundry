...
describe('modal', () => {
  ...
  it('can have custom HTML classes', async () => {
    ...
    wrapper.vm.open()
    await wrapper.findComponent(TransitionStub).vm.emitAfterEnter()
    expect(wrapper.get('[data-test-id="modal-body"]').classes()).toContain('bogus-class')
  })
  ...
  it('can be opened and closed', async () => {
    ...
    await wrapper.get('[data-test-id="modal-transition-inner"]').findComponent(TransitionStub).vm.emitAfterLeave()
